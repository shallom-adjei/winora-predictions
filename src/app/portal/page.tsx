...
function Sidebar({
  ...
  const menuItems = [
    { title: "Dashboard", icon: BarChart3, href: "/portal" },
    { title: "Predictions", icon: TrendingUp, href: "/portal/predictions" },
    { title: "Upcoming Matches", icon: Activity, href: "/portal/matches" },
    { title: "Results", icon: TrendingUp, href: "/portal/results" },
    { title: "Blog", icon: BarChart3, href: "/portal/blog" },
    { title: "Settings", icon: Settings, href: "/portal/settings" },
    { title: "Profile", icon: Users, href: "/portal/profile" },
  ];
